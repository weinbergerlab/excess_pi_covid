...
params<-c('sum.n','sum.lambda',
         'beta.logged', 'alpha', 'phi', 'baseline','sum.beta')
...
matplot(all.preds[350:nrow(all.preds),], type='l', lty=c(1,2,2), col=c('black','gray','gray'))
points(date.sum[350:nrow(all.preds)], type='p',pch=16 ,col='red')
```

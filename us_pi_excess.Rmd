...
for(i in 1:dim(pred.iter.ac2)[3]){
...
state.ac.q <- apply(pred.iter.ac4,c(1,3), quantile , probs=c(0.025, 0.5, 0.975))

#Sum the state-level estimates to get national estimate
pred.iter.ac2.nat <-
  pred.iter.ac3[,,dimnames(pred.iter.ac3)[[3]]!='US']
...
stack_plot_func(nat.range.ac2, scale.plot=1.3,legend.loc='bottomleft')

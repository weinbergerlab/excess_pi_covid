...
NOTE: This page is no longer being maintained. The final update for this page was completed August 14, 2020 and covers the period from March-July 2020. A manuscript covering the full methods was published in *JAMA Internal Medicine* and can be found [here](https://jamanetwork.com/journals/jamainternalmedicine/fullarticle/2767980). The full analysis code can be found [here](https://github.com/weinbergerlab/excess_pi_covid).

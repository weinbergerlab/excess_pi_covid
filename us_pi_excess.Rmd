...
```{r}
excess_pi[dim(excess_pi)[1],'NJ',1]/excess_all_cause[dim(excess_all_cause)[1],'NJ',1]

excess_pi[dim(excess_pi)[1],'NY',1] /(excess_all_cause[dim(excess_all_cause)[1],'NY',1]+excess_all_cause[dim(excess_all_cause)[1],'NYC',1])
...
## Table S3: Proportion of COVID-19 deaths with a pneumonia code, by state
```{r}
...
htmlTable(cdc.summary.state.clean)
```


##Table S3: Do not adjust for underreporting of deaths

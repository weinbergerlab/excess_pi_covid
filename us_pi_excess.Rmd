...
res.ac2$denom <-NULL
names(res.ac2) <-
  c('state','week_end_date','year','week','day','week_start','baseline_all_cause','baseline_all_cause_lower', 'baseline_all_cause_upper', 'all_cause_deaths','excess_all_cause_deaths', 'nchs.covid.deaths')
...
points (st1$week_end_date ,st1$nchs.covid.deaths,type='l', col='red')

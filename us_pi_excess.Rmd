...
stack_plot_func(nat.range.ac2.spl[['NJ']], legend=F,scale.plot=fig.scaling, set.ymax = 4500)
title("New Jersey")

stack_plot_func(nat.range.ac2.spl[['IL']], legend=F,scale.plot=fig.scaling, set.ymax = 4500)
title("Illinois")

stack_plot_func(nat.range.ac2.spl[['MI']], legend=T,scale.plot=fig.scaling, set.ymax = 4500,legend.loc='bottomleft')
title("Michigan")

stack_plot_func(nat.range.ac2.spl[['MA']], legend=F,scale.plot=fig.scaling, set.ymax = 4500)
title("Massachusetts")

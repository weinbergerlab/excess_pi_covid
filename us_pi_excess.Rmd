...
matplot(nat.c[nat.c$year_week_num<=14,-1], type='l', col=cols1, bty='l', ylab='N deaths')
...
diffs <- diffs[diffs$year_week_num<=14,]
...
diffs.epiwk$diff2015 <- diffs.epiwk$`2019` -
  diffs.epiwk$`2015`
#diffs.epiwk <- diffs.epiwk[diffs.epiwk$year_week_num<=14,]

...
```{r states_to_plot}
plot.states <- c('CA','TX','FL', 'NY','PA','IL','OH','GA','MI','LA', 'MA' )
...
jh3a <- jh3a[,c('state','week_start','total_pi',"excess_pi","covid.track.death","test.week.per.capita",'testN' )]
...
end.summary <- ac.summary.state3[ac.summary.state3$year==2020 & ac.summary.state3$week>=10 & ac.summary.state3$week<=14 & ac.summary.state3$state %in% c('FL','LA','MI','NJ','NY','NYC','PA', 'MA', 'CA', 'IL'),]

...
stack_plot_func(nat.range.ac2, scale.plot=1.3)
...
mod.flu <- glm(log.flu.lag1 ~ sin52 +cos52 +sin26 +cos26 +sin13+cos13+epiyr, data=nat1)
pred.flu <- predict(mod.flu)
nat1$log.flu.deseasonalize <- nat1$log.flu.lag1-pred.flu
nat1$log.flu.deseasonalize.0 <- nat1$log.flu.deseasonalize
nat1$log.flu.deseasonalize.0[nat1$log.flu.deseasonalize.0<0] <-0

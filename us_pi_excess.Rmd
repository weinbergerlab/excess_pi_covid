...
par(mfrow=c(4,4))
ts.plot.func(ds.plot=jh3, death.var='covid.track.death' ,states.plot=states.cdc )
...
count.excess2 <- aggregate(count.excess[,c('excess_pi','covid.track.death')], by=list('state'=count.excess$state) ,FUN=sum)

htmlTable(count.excess2)
```

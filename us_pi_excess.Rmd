...
#   called again?
runIfExpired <- function(storeName, f, maxage=hours(2)) {
  basepath <- "Data/"
...
plot(diffs.epiwk$epiwk.num, diffs.epiwk$diff2018, type='l',ylim=c(-5000, 8000), main='2019/20 minus prev. years', xaxt='n')

...
ts.plot.func(ds.plot=jh3.trim,   states.plot=c('MA','TX','CA','WA'),ylim.adj=15.0 ,death.var="covid.death.hybrid" ,plot.order=T, plot.excess='ac')
title(xlab = "Date",
      ylab = "N Deaths",
...
legend('bottomleft',col=cols1, lty=1:4, ncol=2)

...
ds$band2 <- ds$band1 +  ds$excess_pi_unexp
...
polygon(c(ds$week_end, rev(ds$week_end)), c(ds$band1, rev(ds$band2)),col = rgb(252/255,141/255,98/255, alpha = 1), border = NA )
...
legend(legend.loc,inset=0.025, 
       ...
       lty=c(NA, NA, NA, 1,2), 
       lwd=c(NA, NA, NA, 1,2), 
       legend=c(  'Unattributed Excess','Other Pneumonia & Influenza','Reported COVID-19', 'Observed Deaths', 'Expected Deaths'),

...
names(nchs.base2.data) <- c("State","End.Week", 'Total.Deaths'  )
...
analysis.data$one <- 1
analysis.data2 <-
    analysis.data[!is.na(analysis.data$nchs.pic),]
set.seed(123)
excess_pi_natl <-
...
excess.combined <-
  merge(formatted.excess.pic,pop2, by='state')

#NYcity and nY state set pop manually
excess.combined$census_bureau_pop_2019[excess.combined$state=='NYC'] <- 8399900

excess.combined$census_bureau_pop_2019[excess.combined$state=='NY'] <- 19450000- 8399900
...
excess.combined$covid.death.hybrid.rate <-excess.combined$covid.death.hybrid/excess.combined$census_bureau_pop_2019*100000

excess.combined$pct.unattrib.pic <- excess.combined$covid.death.hybrid/excess.combined$`Excess P&I&C`
excess.combined$pct.unattrib.pic[excess.combined$pct.unattrib.pic>1] <-1

excess.combined <- excess.combined[,c('state',"census_bureau_pop_2019",'covid.death.hybrid',"covid.track.death","covid.death.hybrid.rate", "Excess P&I&C",'pct.unattrib.pic'  )]
write.csv(excess.combined,'./outputs/excess.summary.march.apr.csv')
```
